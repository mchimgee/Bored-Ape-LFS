...
function cosmosSignTx(transport, msg) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return transport.lockDuring(() => __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (yield protoTxBuilder).sign(msg.tx, offlineSigner, msg.sequence, msg.account_number, msg.chain_id);
        }));
    });
}
