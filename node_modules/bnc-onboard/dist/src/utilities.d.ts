import { QuerablePromise, WalletInterface, CancelablePromise } from './interfaces';
...
export declare function makeQuerablePromise(promise: CancelablePromise): QuerablePromise;
